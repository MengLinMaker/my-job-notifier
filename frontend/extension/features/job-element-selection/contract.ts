...
export const SIMILAR_ATTRIBUTE = 'data-my-job-notifier-similar'
export const HOVERED_DATA_VALUE = 'true'
export const HOVERED_SELECTOR = `[${HOVERED_ATTRIBUTE}="${HOVERED_DATA_VALUE}"]`
export const SIMILAR_SELECTOR = `[${SIMILAR_ATTRIBUTE}="${HOVERED_DATA_VALUE}"]`
